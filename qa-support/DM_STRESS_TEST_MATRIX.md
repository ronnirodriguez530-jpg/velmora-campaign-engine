...
| QP-06 | Player completes one of two parallel routes | Sibling route remains unresolved unless a durable consequence actually makes its premise impossible | PASS | Integration coverage proves sibling preservation and rejects evidence-free cleanup. See ROUTE_INVALIDATION_SPEC.md. |
| QP-07 | World consequences make one unresolved route impossible | Impossible route is preserved in journal as failed; sibling route remains untouched; invalidation cites durable causal evidence | PASS | Runtime requires 1-4 durable events directly related to the quest's recorded people, faction, location, or thread; journal history and rollback are covered. |
