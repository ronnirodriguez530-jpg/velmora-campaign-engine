...
function parseSubmittedPlan(value: unknown): DirectorTurnPlan {
  ...
  if (plan.questUpdates.length > 3) throw new Error("Cloud Director may update at most three quests per turn");
