  ...
  parameters: {
    ...
    properties: {
      ...
      questUpdates: {
        type: "array",
        maxItems: 3,
        description: "Manage supplied quests only when justified. Warning records require a received stored signal. Neglect requires new evidence and one matching bounded complication tool. Consequence-based failure requires durable proof.",
        items: {
          type: "object",
          properties: {
            questId: { type: "string" },
            action: { type: "string", enum: ["make_available", "activate", "complete_objective", "fail_objective", "complete", "fail_recoverably", "fail_from_consequence", "record_warning", "apply_neglect_complication"] },
          ...
          required: ["questId", "action", "objectiveId", "outcomeId", "consequenceEventSequences", "warningMethod", "warningSignal", "warningSourceNpcId", "neglectTrigger", "neglectComplicationTool", "reason"],
          additionalProperties: false
        }
      },
      suggestedActions: {
