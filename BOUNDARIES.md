...
- A fortified containment zone surrounds the central Tear and is publicly justified as necessary for "safety." It is guarded by an independent force attached to the office of the First Speaker, separate from the six factions. Its exact name, construction, effectiveness, and chain of command after the First Speaker falls remain subject to the approved geography design.
