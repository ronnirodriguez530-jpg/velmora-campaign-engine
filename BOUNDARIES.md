...
- The player begins inside the Council Crown during the opening Surge, directly witnesses raw Tear-magic strike the First Speaker, and is present when the Surge fails to end. Why the player is there and their first actionable objective remain part of the unfinished playable-opening design.
- At campaign creation, a player-clicked d6 selects one of six fixed Council Crown spawn situations. The table remains consistent across runs while character-specific details may adapt to the chosen background. The six approved entries are stored in `content/velmora/opening-spawns.json`; the Campaign Master may not invent a seventh result or move the opening outside the Crown.
