...
2. **Generic neglect trigger:** Ordinary failure is approved as recoverable, but the generic trigger currently used to decide when neglect becomes meaningful remains scaffolding.
